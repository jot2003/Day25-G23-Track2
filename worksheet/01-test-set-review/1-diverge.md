...
| R-02 | 2023 | Ryanair | Chatbot CSKH xác nhận sai quy định hành lý xách tay (kích thước cabin), hành khách bị tính phụ thu tại sân bay; khiếu nại ghi nhận trên Which? (UK consumer group) và AirHelp | Which? report 2023: https://www.which.co.uk/news/article/airline-chatbots-giving-wrong-information-aJfGY4p3LZXf — AirHelp chatbot study 2023: https://www.airhelp.com/en/press-release/chatbots-airlines/ | Vừa | Có một phần — URL cần xác minh lại trước khi trình bày |
| R-03 | 2022-2023 | Hãng hàng không nội địa VN (Vietjet/Bamboo) | Chatbot trả lời sai quyền lợi bồi thường khi delay >2h theo Thông tư 14/2015/TT-BGTVT, hành khách không biết mình có quyền yêu cầu bữa ăn/bồi thường | Vinasa/Hội bảo vệ người tiêu dùng VN — cần tìm URL báo cụ thể (VnExpress, Tuổi Trẻ) | Nặng | Chưa đủ — cần URL bài báo cụ thể |
| R-04 | 2023 | Nhiều hãng hàng không Mỹ | AI/chatbot CSKH hàng không không nhận diện được khách đang bức xúc hoặc có vấn đề khẩn cấp, tiếp tục loop tự động; The Verge đưa tin về làn sóng triển khai AI trong tổng đài hàng không và rủi ro kèm theo | The Verge "Airlines Are Using AI for Customer Service. It Isn't Going Well" 2023: https://www.theverge.com/2023/5/1/23706603/airlines-ai-customer-service-chatbot | Rất nặng | Có một phần — tiêu đề bài cần xác minh chính xác |
| R-05 | 2024 | Nhiều hãng bay Đông Nam Á | Bot Zalo/Messenger xử lý yêu cầu đổi vé gần giờ bay nhưng không trigger cảnh báo "cần nhân viên xác nhận", khiến đổi vé bị lỗi hệ thống mà hành khách không biết | Khiếu nại ghi nhận tại Cục Hàng không Việt Nam — chưa có URL công khai cụ thể | Vừa-Nặng | Chưa đủ — cần URL cụ thể |
